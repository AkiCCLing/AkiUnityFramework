    ...
    public class AutoBindCodeSnippetGenerator
    {
        public static List<string> GenerateBindCode(GameObject prefab)
        {
            ...
            foreach (var transform in allTransforms)
            {
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").GetComponent<TextMeshProUGUI>();");
                    continue;
                }
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").GetComponent<Image>();");
                    continue;
                }
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").GetComponent<Button>();");
                    continue;
                }
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").GetComponent<InputField>();");
                    continue;
                }
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").GetComponent<RawImage>();");
                    continue;
                }
                ...
                {
                    bindCodes.Add($"{fieldName} = transform.Find(\"{name}\").gameObject;");
                }
            }
